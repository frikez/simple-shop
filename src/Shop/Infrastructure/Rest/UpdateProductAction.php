...
use App\Shop\Application\Command\Product\UpdateProductCommand;
...
final class UpdateProductAction
{
    ...
    /**
     * @Route("/api/products/{productId}", name="api_patch_product", methods={"PATCH"})
     *
    ...
    public function __invoke(Request $request, string $productId): JsonResponse
    {
        ...
        $command = new UpdateProductCommand(
            ...
            new Money($data['price'], Currency::PLN()) ?? null,
        );
